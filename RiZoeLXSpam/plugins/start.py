...
RIZ_IMG = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/4659a89b6640cec45cbaf.jpg"


Riz_Button = [
        [
        Button.url("Dangerous", "https://t.me/Dangerousfighterchannel"),
        Button.url("Dangerous", "https://t.me/Dangerouschatting")
        ],
        [
