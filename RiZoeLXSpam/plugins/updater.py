...
OFFICIAL_UPSTREAM_REPO = "https://github.com/OPBRUTAL/SPAMXD"
BOT_IS_UP_TO_DATE = "**The A4AMAN X Spam** is up-to-date sur."
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "__U𝗽𝗱𝗮𝘁𝗶𝗻𝗴..... 𝗬𝗼𝘂𝗿 A4AMAN 𝗫 𝗦𝗽𝗮𝗺 𝗨𝘀𝗲𝗿𝗯𝗼𝘁𝘀__\n𝗧𝘆𝗽𝗲 .ping 𝗔𝗳𝘁𝗲𝗿 5𝗺𝗶𝗻𝘀 𝗧𝗼 𝗰𝗵𝗲𝗰𝗸 𝗜'𝗺 𝗼𝗻 !!"
